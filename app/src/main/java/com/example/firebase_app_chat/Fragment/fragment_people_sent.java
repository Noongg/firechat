...
public class fragment_people_sent extends Fragment {
    View view;
    RecyclerView recycler_sent;
    FirebaseFirestore firestore;
    LinearLayout search_bar_sent;
    Adapter_fragment_people_friend adapter_user;
    TextView txt_people_count_sent;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_people_sent,container,false);
        recycler_sent=(RecyclerView) view.findViewById(R.id.recycler_sent);
        txt_people_count_sent=(TextView)view.findViewById(R.id.txt_people_count_sent);
        search_bar_sent=(LinearLayout) view.findViewById(R.id.search_bar_sent);

        search_bar_sent.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void loadpeople() {
        ...
        query.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                txt_people_count_sent.setText(String.valueOf(count));
            }
        });
        adapter_user=new Adapter_fragment_people_friend(options,getActivity());
        LinearLayoutManager linearLayoutManager= new LinearLayoutManager(requireContext(),LinearLayoutManager.VERTICAL,false);
        recycler_sent.setLayoutManager(linearLayoutManager);
        recycler_sent.setAdapter(adapter_user);
        recycler_sent.setItemAnimator(null);
